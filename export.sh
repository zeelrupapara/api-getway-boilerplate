...
echo "Environment variables exported for GreenLync API Gateway"
echo "Note: This configuration requires running Redis, MySQL, and NATS services"
echo ""
echo "Quick start options:"
echo ""
echo "1. Using Docker Compose (recommended):"
echo "   docker-compose -f stack.yaml up -d"
echo ""
echo "2. Using individual Docker commands:"
echo "   docker run -d -p 6379:6379 redis:alpine"
echo "   docker run -d -p 3306:3306 -e MYSQL_ROOT_PASSWORD=password -e MYSQL_DATABASE=greenlync mysql:8"
echo "   docker run -d -p 4222:4222 nats:alpine"
echo ""
echo "3. Then run the application:"
echo "   source export.sh && ./main"
echo ""
echo "4. Or use docker-compose for everything:"
